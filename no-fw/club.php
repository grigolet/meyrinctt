...
<section class="py-16">
    <div class="max-w-[1200px] mx-auto px-4">
        ...
        <div class="mb-16">
            <h2 class="text-3xl font-black uppercase mb-8 text-center pb-4 border-b-4 border-primary inline-block">Statistiques des Joueurs</h2>

            <div class="max-w-[1200px] mx-auto mt-12">
                <div class="bg-surface border-2 border-border rounded-xl p-6 shadow-soft">
                    <iframe
                        src="https://ttstats.ch/widget/33165?theme=light&lang=fr"
                        width="100%"
                        height="700"
                        frameborder="0"
                        scrolling="auto"
                        style="border: none; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"
                        title="TTStats Club Widget">
                    </iframe>
                </div>
            </div>
        </div>
        ...
        <div class="bg-primary/5 border-2 border-primary rounded-xl p-8 mb-8 text-center max-w-[800px] mx-auto">
